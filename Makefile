...
navaduel: raylib
ifneq (,$(navaduel_config))
	@echo "==== Building navaduel ($(navaduel_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f navaduel.make config=$(navaduel_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f navaduel.make clean
